...
export default function Header() {
	const RenderThemeChanger = () => {
		...
		if (currentTheme === 'dark') {
			return (
				<button aria-label="Switch to light mode" className='bg-gray-300 p-2 rounder-md hover:ring-2 hover:ring-gray-300 dark:bg-gray-600' onClick={() => setTheme('light')}>
			...
			return (
				<button aria-label="Switch to dark mode" className='bg-gray-300 p-2 rounder-md hover:ring-2 hover:ring-gray-300 dark:bg-gray-600' onClick={() => setTheme('dark')}>
					<svg svg="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6" >
